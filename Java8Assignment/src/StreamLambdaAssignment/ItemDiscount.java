...
public class ItemDiscount {
	...
	List<Double>result=item_List.stream().filter(e->e.getCategory().equalsIgnoreCase("Laptops"))
			.map(m->m.getPrice()*0.05).collect(Collectors.toList());
		
	
	System.out.println("Discount Of Laptop is"+result);
